...
public struct KPermission {
    ...
    /// 取的麥克風權權限狀態
    public func getMicrophonePermission () -> AVAudioSession.RecordPermission {
    ...
    public func getCameraPermission(AVMediaType type:AVMediaType) -> AVAuthorizationStatus{
    ...
    ///.denied：使用者明確的拒絕媒體捕獲的權限。
    ///.authorized ：使用者明確的允許媒體捕獲權限，或者對於相關媒體類型不需要明確的使用者權限。
    public func getPHPhotoPermission() -> PHAuthorizationStatus{
